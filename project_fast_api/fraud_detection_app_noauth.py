...
async def welcome_message()->str:
    ...
    """
    return "Hello user, fraud detection app is running !"


@api.get("/test_performance/{model_version}")
...
@api.get("/random_predict/{model_version}")
...
@api.post("/predict/{model_version}")
